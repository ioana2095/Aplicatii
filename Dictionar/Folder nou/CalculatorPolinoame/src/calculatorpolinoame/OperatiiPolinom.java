 ...
 */
package src.calculatorpolinoame;
...
public class OperatiiPolinom {
	...
	MonoPolinom rest=new MonoPolinom(p1.getGrad()) ;
        MonoPolinom cat=new MonoPolinom(1);;
        int[]rest1=rest.getPolinom();
        int[]cat1=cat.getPolinom();
		if (p1.getGrad() < p2.getGrad()) {
		 ...
		 cat = new MonoPolinom(p1.getGrad() - p2.getGrad()+1);	
                 ...
                 cat1=cat.getPolinom();
                 int[]imparti=impartitor.getPolinom();
